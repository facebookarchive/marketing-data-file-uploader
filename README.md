...
* User configured settings file.  See example [here](https://github.com/facebookincubator/offline-conversions-file-uploader/blob/master/oca_file_uploader.conf.yml.example)
* User configured column mapping file.  See example [here](https://github.com/facebookincubator/offline-conversions-file-uploader/blob/master/oca_column_mapping.json.example)
...
See example file here:  [here](https://github.com/facebookincubator/offline-conversions-file-uploader/blob/master/oca_file_uploader.conf.yml.example)

### Column Mapping File

You need to define what each column in the file is for.  See an example [here](https://github.com/facebookincubator/offline-conversions-file-uploader/blob/master/oca_column_mapping.json.example)

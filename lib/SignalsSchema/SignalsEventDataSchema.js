...
var SignalsEventDataSchema = {
  ...
  props: [{
    ...
    key: 'content_type',
    label: 'Content Type',
    formats: ['product', 'product_group', 'fb_product', 'destination', 'flight', 'hotel', 'home_listing', 'auto_offer', 'vehicle', 'test_vertical'],
    type: 'enum',
    typeParams: {
      caseInsensitive: true,
      options: ['product', 'product_group', 'fb_product', 'destination', 'flight', 'hotel', 'home_listing', 'auto_offer', 'vehicle', 'test_vertical'],
      rejectHashed: true
    },

...
var uploadEventsBatch = exports.uploadEventsBatch = function uploadEventsBatch(events, uploadSessionTag, fileOffset, configs, callback) {
  ...
  if (configs.silent !== true) {
    (0, _Logger.getLogger)().info('Posting rows ' + (0, _UploadSession.getBatchSigStr)({ offset: fileOffset, size: events.length }) + ' to ' + (0, _APISettings.datasetEndpoint)(configs.dataSetId, configs.apiVer) + '/events');

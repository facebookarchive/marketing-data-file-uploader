...
var scheduleBatchUpload = exports.scheduleBatchUpload = function scheduleBatchUpload(jobQueue, normalizedEventsBatch, numEvents, uploadSessionTag, configs) {
...
var uploadBatch = function uploadBatch(data, callback) {
  (0, _EventsUploader.uploadEventsBatch)(data.normalizedEventsBatch, data.uploadSessionTag, _getBatchOffset(data.numEvents, data.normalizedEventsBatch.length), data.configs, callback);
};

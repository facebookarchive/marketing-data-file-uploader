...
describe('buildConfigs', function () {
  it('should read config values from sources and merge them', function () {
    var _buildConfigs = (0, _ConfigsBuilder.buildConfigs)(['node', 'OfflinConversionsFeedUploader.js', '--configFilePath', TEST_CONFIG_FILE_PATH, '--accessToken', 'ABCDE', '--columnMappingFilePath', TEST_COL_MAPPING_FILE_PATH]),
  ...
  it('should override values in file with command line args', function () {
    var _buildConfigs2 = (0, _ConfigsBuilder.buildConfigs)(['node', 'OfflinConversionsFeedUploader.js', '--configFilePath', TEST_CONFIG_FILE_PATH, '--accessToken', 'ABCDE', '--apiVer', '2.9', '--inputFilePath', '/NEW/FILE/PATH']),
  ...
  it('should ignore random arguments', function () {
    var _buildConfigs3 = (0, _ConfigsBuilder.buildConfigs)(['node', 'OfflinConversionsFeedUploader.js', '--configFilePath', TEST_CONFIG_FILE_PATH, '--accessToken', 'ABCDE', '--apiVer', '2.9', '--inputFilePath', '/NEW/FILE/PATH', '--randomArg', 'randomArgValue']),
  ...
  it('should return error for invalid api version provided', function () {
    var _buildConfigs4 = (0, _ConfigsBuilder.buildConfigs)(['node', 'OfflinConversionsFeedUploader.js', '--configFilePath', TEST_CONFIG_FILE_PATH, '--accessToken', 'ABCDE', '--apiVer', '5.0', '--inputFilePath', '/NEW/FILE/PATH']),
        err = _buildConfigs4.err;

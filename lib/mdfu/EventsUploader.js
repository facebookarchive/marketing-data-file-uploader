...
var _getAPIEndpoint = function _getAPIEndpoint(configs) {
  switch (configs.mode) {
    case _FeedUploaderConstants.MODE_OC:
      return (0, _APISettings.datasetEndpoint)(configs.dataSetId, configs.mode);
    case _FeedUploaderConstants.MODE_CA:
      return (0, _APISettings.datasetEndpoint)(configs.customAudienceId, configs.mode);
    default:

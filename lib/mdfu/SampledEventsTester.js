...
var checkSampledEvents = function checkSampledEvents(normalizedEvents, configs, callback) {
  ...
  var err = checkInvalidSignalRate(normalizedEvents, rowName, configs);
  if (err) {
    callback(err);
  } else {
...
var checkInvalidSignalRate = function checkInvalidSignalRate(normalizedEvents, rowName, configs) {

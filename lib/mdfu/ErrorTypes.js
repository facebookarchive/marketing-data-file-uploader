...
var ERROR_NO_CA_ID_OR_ACT_ID = exports.ERROR_NO_CA_ID_OR_ACT_ID = 'To upload a custom audience, either a custom audience id (for updating) ' + 'or an ad account id (for creating) is required';
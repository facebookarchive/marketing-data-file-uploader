...
const SignalsEventDataSchema = {
  additionalInfoURL: 'https://www.facebook.com/help/606443329504150',
  id: 'event_data_schema',
  version: '0.0.2',
  exampleFiles: {
    csv:
      'https://www.facebook.com/images/ads/signals/example_files/example_events_file.csv',
  },
  validIf: {
    rule: 'meetAll',
    args: [
      ...
      },
      {
        ...
        args: [
          ...
          {
            rule: 'dependentProps',
            name: 'require_non_empty_content_ids_if_content_type',
            args: [
              {
                rule: 'propValid',
                args: 'content_type',
  ...
  props: [
    ...
    },
    {
      ...
      type: {
        ...
        exampleFiles: {
          csv:
            'https://www.facebook.com/images/ads/signals/example_files/example_audience_file.csv',
        },
        validIf: {
          rule: 'minValidProps',
          args: 1,
        ...
        props: [
          ...
          },
          {
            ...
            typeParams: {
              ...
              test:
                '^([a-zA-Z0-9]{8}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]' +
                '{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{12}|[a-zA-Z0-9]' +
                '{6}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]' +
                '{4}-[a-zA-Z0-9]{13})$',
            },
          },
          {

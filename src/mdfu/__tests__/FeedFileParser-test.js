...
describe('parseAndNormalizeFeedLine', () => {
  it('should normalize and hash match keys correctly', () => {
    const normlizationResult = parseAndNormalizeFeedLine(
      'elizabetho@fb.com,1-(650)-561-5622,10/21/68,Purchase,' +
      '2017-01-10T03:21:48Z,1115,15,USD',
      CONFIGS_GOOD,
    );
  ...
  it('should normalize dates with inforForNormalization correctly', () => {
    const infoForNormalization = {
      dob: 'MM/DD/YYYY',
      event_time: {
        timeFormat: 'ISO8601',
      },
    ...
    const normlizationResult = parseAndNormalizeFeedLine(
      'elizabetho@fb.com,1-(650)-561-5622,10/21/1968,Purchase,' +
      '2017-01-10T03:21:48Z,1115,15,USD',
      {
        colMappingInfo: {
    ...
    expect(normlizationResult.normalizedValue.match_keys.dobm).toEqual(
      '4a44dc15364204a80fe80e9039455cc1608281820fe2b24f1e5233ade6af1dd5'
    );
    expect(normlizationResult.normalizedValue.match_keys.doby).toEqual(
      'a48622b535728587fd351763d1296c7ec9cb5bc6743d5f22b011d5b5c3ef688f'
    );
  });

  it('should normalize dates with customTypeInfo correctly', () => {
